...
export type Entity<Type extends EntityType, EntityDetails extends DataSchema> = Readonly<ConvertDataSchemaToType<EntityDetails> & {entityType: Type, entityId: EntityId}>;